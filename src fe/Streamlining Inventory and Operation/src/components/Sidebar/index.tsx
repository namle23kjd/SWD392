...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  function checkAdminRole() {
    return currentRoles.length > 0 && currentRoles.includes('Admin')
  }
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              <NavLink
                                to={`/${checkStaffRole() ? 'staff' : 'manager'}/shelfs`}
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                            ...
                            <li>
                              <NavLink
                                to={`/${checkStaffRole() ? 'staff' : 'manager'}/lots`}
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              <NavLink
                                to={`/${checkStaffRole() ? 'staff' : 'manager'}/import-product`}
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                            ...
                            {checkManagerRole() && <li>
                              <NavLink
                                to="/manager/transaction-management"
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              <NavLink
                                to={`/${checkStaffRole() ? 'staff' : 'manager'}/order-history`}
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
                            ...
                            <li>
                              <NavLink
                                to={`/${checkStaffRole() ? 'staff' : 'manager'}/create-order`}
                                className={({ isActive }) =>
                                  'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                  (isActive && '!text-white')
                                }
